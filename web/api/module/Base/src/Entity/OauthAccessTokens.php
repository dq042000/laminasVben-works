...
/**
 * Base\Entity\OauthAccessTokens
 *
 * @ORM\Entity(repositoryClass="OauthAccessTokensRepository")
 * @ORM\Table(name="oauth_access_tokens", options={})
 */
class OauthAccessTokens implements InputFilterAwareInterface
{
    /**
     ...
     *
     * @return \Base\Entity\OauthAccessTokens
     */
    ...
    {
        $dataFields = ['access_token', 'client_id', 'user_id', 'expires', 'scope'];
        $relationFields = [];
        $copiedFields = [];
    ...
    {
        return ['access_token', 'client_id', 'user_id', 'expires', 'scope'];
    }
}